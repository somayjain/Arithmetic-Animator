...
function next()
{
	...
	if(write == 0)
	{
        ...
        else
        {
			...
			say="2. Number of objects in a Column is "+n+". Since it is just "+(cells-n)+" short of a 'Ten', let us shift objects in the last "+(cells-n)+" columns into the rows below the original "+n+" rows.";
        if(isFirefox == true)
        {
